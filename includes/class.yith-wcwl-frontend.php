	...
	class YITH_WCWL_Frontend {
		...
		public function update_font_awesome_classes( $class ) {
			$exceptions = array(
				...
				'icon-file' => 'far fa-file',
				'icon-time' => 'far fa-clock',
				'icon-download-alt' => 'fas fa-download',
				'icon-download' => 'fas fa-arrow-alt-circle-down',
				'icon-upload' => 'fas fa-arrow-alt-circle-up',
				...
				'icon-share-alt' => 'fas fa-square',
				'icon-resize-full' => 'fas fa-expand-alt',
				'icon-resize-small' => 'fas fa-compress-alt',
				'icon-exclamation-sign' => 'fas fa-exclamation-circle',
				'icon-eye-open' => 'far fa-eye',
				'icon-eye-close' => 'far fa-eye-slash',
				'icon-warning-sign' => 'fas fa-exclamation',
				...
				'icon-thumbs-up' => 'far fa-thumbs-up',
				'icon-thumbs-down' => 'far fa-thumbs-down',
				...
				'icon-bookmark-empty' => 'far fa-bookmark-o',
				...
				'icon-circle-arrow-left' => 'fas fa-arrow-alt-circle-left',
				'icon-circle-arrow-right' => 'fas fa-arrow-alt-circle-right',
				'icon-circle-arrow-up' => 'fas fa-arrow-alt-circle-up',
				'icon-circle-arrow-down' => 'fas fa-arrow-alt-circle-down',
				...
				'icon-envelope-alt' => 'fas fa-envelope',
