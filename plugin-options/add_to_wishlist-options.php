...
return apply_filters( 'yith_wcwl_add_to_wishlist_options', array(
	'add_to_wishlist' => array(
		...
		'add_to_wishlist_icon' => array(
			...
			'default'   => apply_filters( 'yith_wcwl_add_to_wishlist_std_icon', 'far fa-heart', 'yith_wcwl_add_to_wishlist_icon' ),
			'type'      => 'yith-field',
			'class'     => 'icon-select',
			'yith-type' => 'select',
		...
		'added_to_wishlist_icon' => array(
			...
			'default'   => apply_filters( 'yith_wcwl_add_to_wishlist_std_icon', 'fas fa-heart', 'yith_wcwl_added_to_wishlist_icon' ),
			'type'      => 'yith-field',
			'class'     => 'icon-select',
			'yith-type' => 'select',
